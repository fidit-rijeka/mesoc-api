# Generated by Django 3.1.3 on 2021-05-05 08:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(1, 'scientific'), (2, 'pilot')])),
                ('document_title', models.CharField(max_length=400, validators=[django.core.validators.MinLengthValidator(1)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expires_at', models.DateTimeField(default=datetime.datetime(2021, 5, 19, 8, 27, 23, 858705, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.repositorydocument')),
            ],
        ),
        migrations.AddField(
            model_name='repositorydocument',
            name='cities',
            field=models.ManyToManyField(through='core.RepositoryDocumentCity', to='core.City'),
        ),
        migrations.CreateModel(
            name='RepositoryCellKeyword',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('value', models.CharField(max_length=100)),
                ('cell', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='keywords', to='core.repositorycell')),
            ],
        ),
        migrations.AddField(
            model_name='repositorycell',
            name='document',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cells', to='core.repositorydocument'),
        ),
        migrations.CreateModel(
            name='PasswordReset',
            fields=[
                ...
                ('uuid', models.UUIDField(default=uuid.uuid4, unique=True)),
                ('requested_at', models.DateTimeField(auto_now_add=True)),
                ('expires_at', models.DateTimeField(default=datetime.datetime(2021, 5, 19, 8, 27, 23, 857963, tzinfo=utc))),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
